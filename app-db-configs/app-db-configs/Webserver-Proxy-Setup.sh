...
# Copy the Apache2 Proxy Config File From S3 (using the object URI)
sudo rm /etc/apache2/sites-available/000-default.conf
sudo aws s3 cp s3://prod-app-justine-1965/app-db-configs/app-db-configs/000-default.conf /etc/apache2/sites-available/
